...
// ==========================================
// 2. LÓGICA DE SALVAR O PEDIDO NO BANCO
// ==========================================
        ...
        linhas.forEach((linha, index) => {
            ...
            if (qtd > 0) {
                ...
                itensDetalhados.push({
                    ...
                    cor: linha.querySelector('.item-color').value,
                    mts: linha.querySelector('.item-mts').value,
                    obs: linha.querySelector('.item-obs').value,
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (itensBody && itensBody.children.length === 0) {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            tr.innerHTML = `
                <td style="text-align: center; font-weight: bold;">${letras[i]}</td>
                ...
                <td><input type="text" class="item-color"></td>
                <td><input type="text" class="item-mts"></td>
                <td><input type="text" class="item-obs"></td>
                ...
                if (pedido.detalhes) {
                    ...
                    itens.forEach((item, index) => {
                        if(linhas[index]) {
                            ...
                            linhas[index].querySelector('.item-color').value = item.cor || '';
                            linhas[index].querySelector('.item-mts').value = item.mts || '';
                            linhas[index].querySelector('.item-obs').value = item.obs || '';
